...
public class Latest_runs extends JFrame {
    private JPanel panel;
    public static void main(String[] args){
        Latest_runs latest_runs = new Latest_runs();
        HIGHSCORE jFrameDemo = new HIGHSCORE();
    }    
    public Latest_runs(){
        ...
        JLabel label_1 = new JLabel("Latest Runs");
        ...
        for(int i=1;i<=antal_inputs;i++){
            ...
            JTextField textField = new JTextField("T "+ Integer.toString(i));
